# LOCATION: https://gitlab.com/ziegleto-machine-learning/dino/-/tree/main/
...
if __name__ == '__main__':
    ...
    img = Image.open('my_test/sign_language_photo/Screenshot1.png')
    img = img.convert('RGB')
    ...
    for j in range(nh):
        fname = os.path.join(output_dir, "my_test/sign_language_photo/attns/attn-head" + str(j) + ".png")
