# LOCATION: https://jvgd.medium.com/dinov2-visualization-4a9df1a42387 (https://freedium.cfd/https://jvgd.medium.com/dinov2-visualization-4a9df1a42387)
...
I1 = read_image("my_test/dino_test_imgs/elephant_1.png", ImageReadMode.RGB).to(device)
I2 = read_image("my_test/dino_test_imgs/elephant_2.png", ImageReadMode.RGB).to(device)
...
B, L, _ = E_patch.shape
Z = B * L
I_draw = torch.zeros(Z,3).to(device)
...
# Saving
save_image(image_1_pca, "my_test/dino_test_imgs/image_1_pca.png")
save_image(image_2_pca, "my_test/dino_test_imgs/image_2_pca.png")