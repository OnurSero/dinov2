...
def train_loop_only_3d_heatmap():
    ...
    for epoch in range(1, num_epoch+1):
        ...
        avg_test_accuracy, avg_top5_test_accuracy, avg_test_loss = test_model_only_3d_heatmap(test_loader, model, criterion)
    ...
    save_model_result(model, current_time, num_classes, avg_accuracy_list, avg_test_accuracy_list, avg_top5_test_accuracy_list, avg_loss_list, avg_test_loss_list)
